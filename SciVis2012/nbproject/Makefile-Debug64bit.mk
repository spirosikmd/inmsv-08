...
${OBJECTDIR}/source/DataBuffer.o: source/DataBuffer.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -Wall -Ilibraries/fftw-2.1.5/include -MMD -MP -MF $@.d -o ${OBJECTDIR}/source/DataBuffer.o source/DataBuffer.cpp

${OBJECTDIR}/source/Grid.o: source/Grid.cpp 
	${MKDIR} -p ${OBJECTDIR}/source
	${RM} $@.d
	$(COMPILE.cc) -g -Wall -Ilibraries/fftw-2.1.5/include -MMD -MP -MF $@.d -o ${OBJECTDIR}/source/Grid.o source/Grid.cpp
...
${OBJECTDIR}/source/UniformGrid.o: source/UniformGrid.cpp 
	${MKDIR} -p ${OBJECTDIR}/source
	${RM} $@.d
	$(COMPILE.cc) -g -Wall -Ilibraries/fftw-2.1.5/include -MMD -MP -MF $@.d -o ${OBJECTDIR}/source/UniformGrid.o source/UniformGrid.cpp
