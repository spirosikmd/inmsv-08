...
# CC Compiler Flags
CCFLAGS=-m32 -ggdb -Wall -pipe
CXXFLAGS=-m32 -ggdb -Wall -pipe
...
LDLIBSOPTIONS=-Llibraries/fftw-2.1.5/lib -lglut -lrfftw -lfftw -lGLU -lGL -lglui
...
${OBJECTDIR}/source/Application.o: source/Application.cc 
	${MKDIR} -p ${OBJECTDIR}/source
	${RM} $@.d
	$(COMPILE.cc) -g -Werror -Ilibraries/fftw-2.1.5/include -MMD -MP -MF $@.d -o ${OBJECTDIR}/source/Application.o source/Application.cc
...
${OBJECTDIR}/Colormap.o: Colormap.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -Werror -Ilibraries/fftw-2.1.5/include -MMD -MP -MF $@.d -o ${OBJECTDIR}/Colormap.o Colormap.cpp
...
${OBJECTDIR}/source/main.o: source/main.cc 
	${MKDIR} -p ${OBJECTDIR}/source
	${RM} $@.d
	$(COMPILE.cc) -g -Werror -Ilibraries/fftw-2.1.5/include -MMD -MP -MF $@.d -o ${OBJECTDIR}/source/main.o source/main.cc

${OBJECTDIR}/source/Simulation.o: source/Simulation.cc 
	${MKDIR} -p ${OBJECTDIR}/source
	${RM} $@.d
	$(COMPILE.cc) -g -Werror -Ilibraries/fftw-2.1.5/include -MMD -MP -MF $@.d -o ${OBJECTDIR}/source/Simulation.o source/Simulation.cc
